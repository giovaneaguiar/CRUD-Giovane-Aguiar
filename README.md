...
<p align="center">Aplicação de Cadastro <strong>(CRUD)</strong> com criação, leitura, atualização e exclusão de produto utilizando <strong>Angular</strong>. Desenvolvido com <strong>back-end simples</strong>, focado no <strong>front-end</strong>.</p>
